...
export const sendEmail = async (to: string, resetLink: string) => {
  ...
  const mailOptions = {
    ...
    to,
    subject: "Password Reset - Anti Crime Reporting System",
    html: `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #dddddd; border-radius: 10px;">
    <h2 style="color: #0073e6; text-align: center;">Anti Crime Reporting System</h2>
    <h3 style="color: #333333;">Reset Your Password</h3>
    <p style="color: #333333; font-size: 16px;">
      Hi there,
    </p>
    <p style="color: #333333; font-size: 16px;">
      We received a request to reset the password associated with your account on the Anti Crime Reporting System. If you didn't request a password reset, please ignore this email.
    </p>
    <p style="color: #333333; font-size: 16px;">
    ...
    <p style="color: #333333; font-size: 16px;">
      Thanks,<br/>
      The Anti Crime Reporting System Team
    </p>
    <hr style="border: 0; border-top: 1px solid #dddddd;">
    <p style="font-size: 12px; color: #aaaaaa; text-align: center;">
      If you have any issues, please contact us at support@anticrimereporting.com.<br/>
      © 2024 Anti Crime Reporting System. All rights reserved.
    </p>
  </div>
  `,
  };
